...
//soru13
//Metotların amacı; programın yapısal olmasını sağlamak ve birbiriyle ilgili komutları veya programın bir bölümünü istenen isim altında toplamaktır. Bu şekilde programın okunması kolaylaşmakta ve yapısal bir görünüm kazanmaktadır. Bir metot, bir veya daha fazla ifade içerebilir.

//soru14
//Return metotlar çağrıldığında geriye bir değer döndürürken, Void metotlar geriye bir değer döndürmemektedir.

//soru15
//Metot tanımlanırken parantez içinde belirtilir.
//Metodu çağırırken, belirtilen parametre sayısı kadar argüman verilmelidir.
//Parametre türleri: Değer(Value) ve Referans(Reference) şeklinde olabilir.
